                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a class="" href="{{ url(Config::get('constants.ADMIN_PATH').'achats'.'/create') }}">
                                        ...
                                        <td>{{ $item->user->nom .' '.$item->user->prenom }}</td>
                                         ...
                                         <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ url(Config::get('constants.ADMIN_PATH').'achats/' . $item->id . '/edit') }}" title="Edit Category"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editer</a>
                                                    </li>

                                                    <li>
                                                        <form method="POST" action="{{ url(Config::get('constants.ADMIN_PATH').'achats' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                            {{ method_field('DELETE') }}
                                                            {{ csrf_field() }}
                                                            <button type="submit" class="dropdown-item" title="Delete Achat" onclick="return confirm('Voulez vous vraiment supprimer ?')"><i class="fa fa-trash-o" aria-hidden="true"></i> Supprimer</button>
                                                        </form>
                                                    </li>
                                                </ul>
                                            </div>
