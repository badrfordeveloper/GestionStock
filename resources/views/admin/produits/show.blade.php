                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content  text-center">
                        ...
                        <div class="table-responsive">
                         ...
                         <a href="{{ url('/admin/produits/' . $produit->id . '/edit') }}" title="Edit Produit"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editer</button></a>
