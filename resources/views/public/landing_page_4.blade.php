    ...
    <div class="container">
      ...
      <div class="row centered">
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <h4>استفد الان من العرض  و التوصيل إلى باب دارك  <i class="glyphicon glyphicon-heart"></i></h4>
    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-4">
          ...
          <p>
		  قم بازالة الخملة والشعر و ايضا شعر الحيوانات من ملابسك بسحبة واحدة .
 يكمن السر في آلاف الشعيرات الدقيقة التي تعمل مثل الأصابع التي تلتقط كل قطعة من الفراء أو الزغب.
 
  يعد هدا المنتج رائعًا للاستخدام على: الأثاث والملابس والسجاد والبياضات والوسائد ومقاعد السيارة والمزيد.
  </p>        </div>
    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-4 col-md-offset-2">
          ...
          <p>يتميز هدا المنتج بقاعدة التنظيف الذاتي بغمسة واحدة فقط ، ويتم تنظيف كلا الجانبين بسرعة.الآلاف من الشعيرات الدقيقة التي تعمل مثل الأصابع التي تلتقط كل قطعة من الفراء أو الزغب لا توجد حاجة لإعادة التعبئة.
		  الفرشاة مزدوجة الجوانب لذا يمكنك التنظيف في نصف الوقت. على عكس فرش الوبر التقليدية </p>        </div>
    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-4">
          ...
          <p>لا مزيد من بكرات الشريط المزعجة التي تحتاج إلى الكثير من الأوراق ، أو فرش الوبر العادية التي يصعب تنظيفها!
الحل البسيط والمبتكر لإزالة الخملة و فرو الحيوانات الأليفة بسرعة وسهولة. فقط اسحبها على السطح وستلتقط كل الخملة و الفراء بطريقة سحرية. بعد ذلك ، قم بغمسها في قاعدة التنظيف الذاتي لإزالة الفراء من الفرشاة وستكون جاهزًا للتمرير مرة أخرى .
</p>
...
<!--   <div id="f">
    ...
    <div class="container">
      ...
      <div class="row centered mtb">
        ...
        <h3>احصل على أفضل العروض والتخفيضات لمنتجاتنا</h3>

        <div class="col-md-6 col-md-offset-3 mt" data-effect="slide-bottom">

          <form role="form" action="register.php" method="post" enctype="plain">

            <input type="email" name="email" class="subscribe-input" placeholder="أدخل بريدك الإلكتروني..." required>

            <button class='btn btn-lg btn-green subscribe-submit' type="submit">نعم أريد </button>
        ...
        <div class="col-md-8 col-md-offset-2">
          ...
          <form class="contact-frm" role="form" action="{{ url('check-out/'.$id) }}" id="frompost" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="name" name="nom" class="form-control" id="contact-nom" placeholder="الإسم الكامل" data-rule="minlen:4" data-msg="Please enter at least 4 chars" >
            ...
            <div class="form-group">
              ...
              <input type="text" name="tel" class="form-control" id="contact-tel" placeholder="رقم الهاتف" data-rule="tel" data-msg="Please enter a valid Tél">
            ...
            <div class="form-group">
              ...
              <input type="text" name="adresse" class="form-control" id="contact-subject" placeholder="العنوان الكامل الخاص بك" data-rule="minlen:4" data-msg="Please enter at least 8 chars of subject">
           ...
           <!--  <div class="loading"></div>
            ...
            <div class="form-send">
              ...
              <button type="submit" class="btn btn-large">أرسل الطلب</button>
