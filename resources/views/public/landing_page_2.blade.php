    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-6 centered">
          ...
          <img src="{{ asset('assets/lp/img/pr2-1.jpg') }}" class="img-responsive aligncenter" width="320" alt="" data-effect="slide-left">
    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-4 col-md-offset-2">
			...
			<p>
				سر مقلاة فليب جاك طلاء Orgreenic بمفصل مزدوج وغير لاصق وغير سام. طلاء Orgreenic فعال للغاية لدرجة أنه حتى الجبن المحترق يتلاشى بسهولة دون الحاجة إلى خدش ! بالإضافة إلى حقيقة أن جزأيه محكمان بدرجة كافية للحفاظ على العجين بالداخل ، وبالتالي يكون هناك قدر أقل من الانسكاب والأوساخ. مقلاة فليب جاك هي أسهل طريقة لعمل الفطائر! ما عليك سوى صب الخليط ، ثم أغلق الغطاء واقلبه للحصول على فطائرلذيذة !
        ...
        <div class="col-md-6 centered">
          ...
          <img src="{{ asset('assets/lp/img/pr2-2.jpg') }}" class="img-responsive aligncenter" width="320" alt="" data-effect="slide-right">
    ...
    <div class="container">
      ...
      <div class="row mt">
        ...
        <div class="col-md-6 centered">
          ...
          <img src="{{ asset('assets/lp/img/pr2-3.jpg') }}" class="img-responsive aligncenter" width="320" alt="" data-effect="slide-left">
